...
function mostrarStock($conn)
{
    ...
    //var_dump($array);
    echo $array[0]['quantityInStock'], " en stock";
}
...
{
    include 'includes/API_PHP/redsysHMAC256_API_PHP_7.0.0/apiRedsys.php';
    ...
    $currency = '978';
    $transactionType = '0';
    $urlweb_ok = 'http://localhost/mysql/DWES%20UT4%20WebPedidos-20230203/Nueva%20carpeta/pe_inicio.php';
    $urlweb_ko = 'http://localhost/mysql/DWES%20UT4%20WebPedidos-20230203/Nueva%20carpeta/pe_inicio.php';
